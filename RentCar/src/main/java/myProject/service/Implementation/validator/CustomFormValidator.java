...
public class CustomFormValidator implements Validator{
	...
	public CustomFormValidator(CustomService serviceCustom){
		this.serviceCustom = serviceCustom;
	}
	
	public boolean supports(Class<?> clazz) {
		return CustomForm.class.equals(clazz);
	}

	public void validate(Object target, Errors errors) {
		CustomForm form = (CustomForm) target;
		...
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "user", "", "Can`t be empty");
