...
public class AccidentFilterFormForUser {
	...
	private List<Integer> customSet = new ArrayList<>();
	...
	public List<Integer> getCustomSet() {
		return customSet;
	}
	public void setCustomSet(List<Integer> customSet) {
